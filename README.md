...
Body 
    ...
    - ssh -i "DevMeet-Backend-secret.pem" ubuntu@ec2-43-204-96-49.ap-south-1.compute.amazonaws.com
    ...
    - Backend
        ...
        - npm intsall pm2 -g
        - pm2 start npm --name "DevMeet-Backend-backend" -- start
        - pm2 logs
...
# Addding a custom Domain name
    ...
    - DNS record: A DevMeet-Backend.in 43.204.96.49
